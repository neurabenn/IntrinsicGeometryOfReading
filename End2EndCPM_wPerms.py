...
module load Python/3.8.2-GCCcore-9.3.0 ### any 3.8 should work.
...
def submit_collect_after(jobid: str, *, dataset_path: str, feature_dir: str, task: str,
                         ...
                         script_path: str = "<path_to>/CollectFeaturesandPredict.py") -> str:
...
def main():
    ...
    ap.add_argument("--env-activate", default="source <path to environment>/bin/activate")
    ap.add_argument("--select-script", default="<path to >/select_features_batch.py")
    args = ap.parse_args()
